...
function PanelObras() {
  ...
  const cargar = useCallback(async () => {
    const [{ data: d }, { data: c }, { data: co }, { data: s }, { data: m }, { data: t }, { data: sm }, { data: f }] = await Promise.all([
  ...
  const resumen = nombres.map(obra => {
    ...
    return { obra, obraId: maestro?.id, cliente: maestro?.cliente ?? null, presupuestoTotal, gastoCompras, gastoSubcontratos, pagadoSubcontratos, manoDeObra, adelantos, pagosSemanales, porReembolsar, cobrado, saldo, facturado, porFacturar }
  })
